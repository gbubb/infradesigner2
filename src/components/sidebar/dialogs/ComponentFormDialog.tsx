...
export const ComponentFormDialog: React.FC<ComponentFormDialogProps> = ({
  ...
  const form = useForm<z.infer<typeof legacyFormSchema>>({
    ...
    defaultValues: {
      ...
      readSpeed: formValues.type === ComponentType.Disk ? ((formValues.readSpeed as number) || 1000) : undefined,
      writeSpeed: formValues.type === ComponentType.Disk ? ((formValues.writeSpeed as number) || 1000) : undefined,
